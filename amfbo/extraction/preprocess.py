...
labels = pd.read_csv('D:/data/GAIA-DataSet-main/MicroSS/gaia.csv')
failure_pre_data: dict = io_utils.load('D:/data/GAIA-DataSet-main/MicroSS/pre_data-10.pkl')
...
io_utils.save('D:/data/GAIA-DataSet-main/MicroSS/detector/normal_traces.pkl', normal_traces)
io_utils.save('D:/data/GAIA-DataSet-main/MicroSS/detector/normal_metrics.pkl', normal_metrics)
...
from amfbo.extraction.trace_event_extractor import slide_window
from amfbo.extraction.utils import io_utils

normal_traces = io_utils.load('D:/data/GAIA-DataSet-main/MicroSS/detector/normal_traces.pkl')
normal_metrics = io_utils.load('D:/data/GAIA-DataSet-main/MicroSS/detector/normal_metrics.pkl')
...
ed = time.time()
io_utils.save('D:/data/GAIA-DataSet-main/MicroSS/detector/trace-detector.pkl', trace_detectors)
io_utils.save('D:/data/GAIA-DataSet-main/MicroSS/detector/metric-detector-strict-host.pkl', metric_detectors)
